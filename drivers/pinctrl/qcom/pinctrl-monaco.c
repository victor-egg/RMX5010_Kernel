...
{
	return platform_driver_register(&monaco_tlmm_driver);
}
arch_initcall(monaco_tlmm_init);

static void __exit monaco_tlmm_exit(void)
{
	platform_driver_unregister(&monaco_tlmm_driver);
}
module_exit(monaco_tlmm_exit);
